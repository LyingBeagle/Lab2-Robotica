...
Ejecutar desde terminal: python graficar_resultados_simple.py
"""
...
# Cargar datos
ruta = os.path.join(os.path.dirname(__file__), 'datos_sensores_simple.csv')
...
plt.tight_layout()
plt.savefig(os.path.join(os.path.dirname(__file__), 'graficos_sensores_simple.png'), dpi=150)
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(os.path.dirname(__file__), 'acciones_robot_simple.png'), dpi=150)
plt.close()

print("Graficos guardados (simple).")
